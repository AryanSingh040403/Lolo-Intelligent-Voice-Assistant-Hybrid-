...
OUTPUT_DIR = "your_output_directory_here" # Replace with your desired output directory 
DATASET_PATH = "your_dataset_path_here" # Replace with the path to your fine-tuning dataset (JSON format)
...
LORA_ALPHA = 64 
LORA_DROPOUT = 0.05
# Targeting all projection layers in Qwen's architecture for LoRA adaptation [13]
...
print(f"Loading model '{MODEL_ID}' with 4-bit quantization for QLoRA fine-tuning...")
